...
const DESK_PROP_NAMES = ["Keyboard", "Cube002", "Plane", "Plane002", "Plane003", "Plane004"];

function hideDeskProps(character: THREE.Object3D) {
  DESK_PROP_NAMES.forEach((name) => {
    const prop = character.getObjectByName(name);
